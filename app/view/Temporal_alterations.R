...
ui <- function(id, GO = NULL) {
  ...
  layout_sidebar(
    ...
    div(
      h3(
        "Temporal Gene Expression Alterations - Dataset I",
        style = "color: #0062cc; margin-bottom: 20px;"
      ),

      p(
        "Analysis of differential gene expression during CCCP treatment and recovery phases using Dataset I temporal data."
      ),
